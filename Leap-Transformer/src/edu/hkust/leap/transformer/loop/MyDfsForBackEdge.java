...
public class MyDfsForBackEdge{
	...
	private final MyDominatorsFinder domFinder;
	
	MyDfsForBackEdge(Chain chain, DirectedGraph peg){
		
		domFinder = new MyDominatorsFinder(chain,peg);
