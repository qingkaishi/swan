...
import cn.edu.nju.swan.transformer.phase1.TransformerForInstrumentation;
import cn.edu.nju.swan.transformer.phase1.WholeProgramTransformer;
import cn.edu.nju.swan.transformer.phase2.JTPTransformer;
...
public class TransformClass {
	...
	private void transformReplayVersion(String mainclass) {
		...
		String[] args1 = { "-cp", ".", "-pp", "-validate", mainclass, "-d",
				path, "-f", "jimple", "-x", "jrockit.", "-x", "edu.", "-x",
				"com.", "-x", "checkers.", "-x", "org.xmlpull.", "-x",
				"org.apache.xml.", "-x", "org.apache.xpath.", "-x", "cn.edu." };
